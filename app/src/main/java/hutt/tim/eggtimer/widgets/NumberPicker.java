...
package hutt.tim.eggtimer.widgets;
...
import hutt.tim.eggtimer.R;

public class NumberPicker extends LinearLayout implements OnClickListener,
        OnFocusChangeListener, OnLongClickListener/*, OnKeyListener*/ {
	...
	/**
	 * When a number has been typed update mCurrent.
	 */
